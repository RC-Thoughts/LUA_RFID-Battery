...
#define ABOUT_1 F("RFID")	//Jetibox line 1
#define ABOUT_2 F("RFID")	//Jetibox line 2
...
void loop() 
{
	...
	if ((uLoopCount < 61)&& bReadCard) {
		uLoopCount++;
		delay(500);	//wait 500ms before continuting so we have >30 seconds before the pack count increases
	}
